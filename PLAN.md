...
| 任务 | 优先级 | 状态 | 认领人 |
|---|---|---|---|
| T1 API 错误重试与退避 | P0 | 未开始 | — |
| T2 流式输出 | P0 | 未开始 | — |
| T3 Ctrl+C 中断当前任务 | P0 | 未开始 | — |
| T4 token 用量与成本统计 | P0 | 未开始 | — |
| T5 上下文管理 | P0 | 未开始 | — |
| T6 worker 工具补齐 grep/glob | P0 | 未开始 | — |
| T7 核心逻辑测试 + CI | P0 | 未开始 | — |
| T8 会话持久化 | P1 | 未开始 | — |
| T9 写操作 diff 预览 | P1 | 未开始 | — |
| T10 crew init 向导 | P1 | 未开始 | — |
| T11 worker 失败兜底 | P1 | 未开始 | — |
| T12 npm 发布 | P1 | 未开始 | — |
